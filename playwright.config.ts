...
export default defineConfig({
  //Tempo máximo para execução de cada testes completo (30 segundos)
  timeout: 60_000,

  /*Tempo máximo para assertions (toBeVisible(), toHaveText()...) 5 segundos
  expect: {
    timeout: 5_000, //Não vale a pena aumentar pq o teste pode ficar lento no tempo de execução, vale a pena usar o timeout explicito
  },*/
